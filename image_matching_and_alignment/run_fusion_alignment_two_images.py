...
target_image_path = base_folder + 'targets/8ft_target/cropped_8_normal.png'
data_folder = base_folder + 'outputs_8ft_target/4 ft/homography_warped_image_4 ft/'
save_dir = base_folder + 'outputs_8ft_target/4 ft/fusion/'
