...
@author: Admin
"""
from find_image_match_homography import*
# from RANSAC_flow_functions import load_pretrained_model as ransac_load
# Input information:
# ----------------------------------------------------------------------------
d = 'near-far'
target_image_dir = './DATA/'+d+'/far/' # the older inspection
sample_image_dir = './DATA/'+d+'/target/' # the newer inspection
save_dir = './DATA/'+d+'/near-far results/'
