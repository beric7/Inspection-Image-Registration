...
def ransac_flow(network, coarse_model, target_image, sample_image, sample_image_name, save_dir):
    ...
    av = get_Avg_Image(sample_image_fine_im, coarse_model.It)
    av.save(save_dir+'/average_'+sample_image_name)
...
def find_peak(model, keypts_target, keypts_sample, target_image_path, sample_image_list, 
    ...
    if bool_count and mconf_best !=0:
    ...
    for target_n in tqdm(range(0, len(target_image_list))):
        ...
        for value in av_list:
            ...
            try:
                ...
                sample_image_fine = ransac_flow(ransac_network, coarse_model, target_image, sample_image, sample_image_name, save_av_dir)
