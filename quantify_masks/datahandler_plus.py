...
# TODO make this better. I think that I shoudl look into zero-centering the 
# input image data. I am worried that I am not doing this properly. 
...
def get_dataloader_sep_folder(data_dir, imageFolder='Images', maskFolder='Masks', batch_size=4):
    ...
    dataloaders = {x: DataLoader(image_datasets[x], batch_size=batch_size, shuffle=True, num_workers=1) for x in ['Train', 'Test']}
